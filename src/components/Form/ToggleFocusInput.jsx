...
function ToggleFocusInput({ value, onChangedValue, inputFontSize = '16px', board, ...props }) {
  // console.log(board)
  const [inputValue, setInputValue] = useState(value)

  const triggerBlur = () => {
    // Update giao diện luôn
    ...
    (board !== null) ? onChangedValue(inputValue, board) : onChangedValue(inputValue)
  }
