...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Lấy activeBoard từ redux mục đích là lấy được toàn bộ thông tin thành viên của board thông qua trường FE_allUsers
  const board = useSelector(selectCurrentActiveBoard)

  // Thành viên trong Card là tập con của thành viên trong Board, để lấy được thông tin các thành viên của Card đang mở: FE_CardMembers,
  // ta cần dựa vào board.FE_CardMembers và cardMemberIds, vì trong cardMemberIds chỉ chứa id mà thôi
  ...
  const handleUpdateCardMembers = (user) => {
    // console.log(user)
    // Tạo 1 biến incomingMemberInfo để gửi lên BE, với 2 thông tin chính là userId và action là xóa khỏi Card hoặc thêm vào Card
